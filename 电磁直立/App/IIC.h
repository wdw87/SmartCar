...
/*************************************************************/
/*********定义时钟线*********/
#define SCLout  gpio_init(PTE1, GPO, 0)//DDRC19=1
#define SCL_L_   PTE1_OUT=0
#define SCL_H_   PTE1_OUT=1
/*********定义数据线*********/
#define SDAout  gpio_init(PTE0, GPO, 0)//DDRD0=1
#define SDA_L_   PTE0_OUT=0
#define SDA_H_   PTE0_OUT=1
#define SDAin   gpio_init(PTE0, GPI, 0)//DDRA15=0
#define SDA_read PTE0_IN
...
int Get_Gyro(unsigned char n,unsigned char Axis);
/*************************************************************/
/*****************函数声明************/
/*************************************************************/
